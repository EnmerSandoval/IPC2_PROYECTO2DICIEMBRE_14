...
from proyectoVacas.producto import *
from proyectoVacas.usuario import *
from proyectoVacas.fact import *
from datetime import datetime
from proyectoVacas.usuario import cliente
import json
import requests
...
def obtencion_datos(ruta):
    ...
    for datos in raiz.findall('productos/producto'):
        ...
        if lista_productos.get_producto(codigo_producto) is None:
            ...
            producto_nuevo = productos(nombre_producto, descripcion_producto,
...
def crear_factura(nit_cliente, nombre_cliente, detalle_factura):
    ...
    factura_nueva = Facturas(nombre_cliente, nit_cliente, fecha_actual_str, detalle_factura)
